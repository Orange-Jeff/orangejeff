...
<head>
    ...
    <style>
        ...
        .bottom-action-bar {
            ...
            background: transparent;
            padding: 0;
            /* Remove padding from the bar itself */
        ...
        .bottom-action-bar .button-row {
            ...
            padding: 10px;
            /* Match the padding with menu-container */
            align-items: center;
            height: 28px;
        }

        /* For iframe mode, align left exactly */
        .iframe-mode .bottom-action-bar .button-row {
            margin: 0;
            /* Remove auto margin */
            padding-left: 10px;
            /* Match the menu container padding */
        }

        .ghosted {
            background: #aaaaaa !important;
            /* Lighter gray, but still visible */
            cursor: not-allowed;
            opacity: 0.8;
...
<body>
    <div class="menu-container">
        ...
        <div class="editor-view">
            <!-- File tree container -->
            <div class="list-title" id="listTitle" style="display:none;"></div>
    ...
    <script>
        ...
        const STATUS_MESSAGES = {
            folder: {
                processing: 'Processing Folder Files',
        ...
        function handleTreeItemClick(e) {
            ...
            // Save the clicked element's position relative to viewport before expanding
            ...
            // Close all siblings first to prevent multiple open items
            ...
            if (!wasExpanded) {
                ...
                // Use setTimeout to let the browser render the expanded content first
                setTimeout(() => {
                    // Calculate where element should be now and adjust scroll to keep it in same position
                    const newY = elementTop - rect.top;
                    window.scrollTo({
                        top: newY,
        ...
        function showLoadingSpinner() {
            const tree = document.getElementById('fileTree');
            tree.innerHTML = `
                <div class="loading-spinner" style="text-align: center; padding: 30px 0;">
                    <i class="fas fa-circle-notch fa-spin" style="font-size: 32px; color: #0056b3;"></i>
                    <p style="margin-top: 15px;">Loading files, please wait...</p>
                </div>`;
        }
