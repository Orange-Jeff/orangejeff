...
</script><link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css"><html lang="en">
...
<body data-new-gr-c-s-check-loaded="14.1232.0" data-gr-ext-installed="">
    ...
    <div id="hamburgerButton" class="hamburger-menu">
        <a href="main.php?app=nb-annotate-it.php" title="Go to Main Menu">
            <i class="fas fa-bars"></i>
        </a>
    </div>

    <script>
        // Hide hamburger when URL has proof parameter (Version 1.1)
        document.addEventListener('DOMContentLoaded', function() {
    ...
    <div class="menu-container">
        ...
        <div class="button-controls">
            <div class="button-row">
                <button type="button" class="command-button" id="btnRestart">
