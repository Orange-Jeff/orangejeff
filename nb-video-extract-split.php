...
<body>
    <div class="editor-view">
        ...
        <script>
            ...
            // Split into two functions - one for full reset, one for restart
            function handleReset() {
                // Simple reset for loading new files
                log.innerHTML = '';
                splits = [];
                video.pause();
                video.src = '';
            ...
            function handleRestart() {
                // Full program restart - reset everything
                log.innerHTML = '';
                splits = [];
                video.pause();
                video.src = '';
                ...
                location.reload(); // Full page reload to ensure clean state
            }
            ...
            function loadFile(file) {
                handleReset(); // Use full reset when loading new file
            ...
            async function processVideoSegment(startTime, endTime, segmentNumber) {
                ...
                return new Promise(resolve => {
                    ...
                    video.onseeked = function drawFrame() {
                        ...
                        attempt++;
                        if (attempt > 300 || video.currentTime === lastTime) {
                            mediaRecorder.stop();
                        }
                    };
                });
