...
<div class="ich-settings-main-wrap">
	<form id="agent_login">
		<input type="hidden" name="profiles" value="MEMBER">
		<section id="rem-agent-page">
			<div class="row">
				...
				<?php do_action( 'rem_register_agent_before_register_button' ); ?>
					<div class="col-sm-12">
						<button class="btn btn-default signin-button" type="submit"><i class="far fa-hand-point-right"></i> <?php esc_attr_e( 'Register as Member', 'real-estate-manager' ); ?></button>
					</div>
			</div>
		</section>
	</form>
